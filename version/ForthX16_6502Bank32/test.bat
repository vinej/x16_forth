...
rem loader.prg/loader32.prg live in the repo root and are reachable over HostFS.
call "%~dp0make.bat"
...
echo.
.\emulator\x16emu.exe -rom .\emulator\rom.bin -cartbin "version\ForthX16_6502Bank32\ForthX16_6502Bank32.bin"
popd
