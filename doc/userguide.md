...
**V** — [`V!`](#x16-video-screen-and-cursor), [`V!W`](#x16-video-screen-and-cursor), [`V@`](#x16-video-screen-and-cursor), [`VADDR`](#x16-video-screen-and-cursor), [`VAL`](#basic-alias-and-string-toolkit), [`VALUE`](#defining-words), [`VARIABLE`](#defining-words), [`VER`](#system-and-environment), [`VLOAD`](#x16-load-and-save), [`VPEEK`](#x16-video-screen-and-cursor), [`VPOKE`](#x16-video-screen-and-cursor), [`VSAVE`](#x16-load-and-save)
